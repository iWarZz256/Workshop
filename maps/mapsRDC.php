...
$sql = "SELECT numero, coords, capacite, etage FROM salle WHERE etage = 0";
...
<body>
    ...
    <a class="<?php echo $current_page == 'mapsRDC.php' ? 'active' : ''; ?>" href="/Workshop/maps/mapsRDC.php">Maps</a>
 ...
 <div class="navbar" style="text-align: center;" id="navbar1">
        <nav>
            ...
            <a class="<?php echo $current_page == '/Workshop/maps/maps1er.php' ? 'active' : ''; ?>" href="/Workshop/maps/maps1er.php">1er étage</a>
            <a class="<?php echo $current_page == '/Workshop/maps/maps2eme.php' ? 'active' : ''; ?>" href="/Workshop/maps/maps2eme.php">2ème étage</a>
            <a class="<?php echo $current_page == '/Workshop/maps/maps3eme.php' ? 'active' : ''; ?>" href="/Workshop/maps/maps3eme.php">3ème étage</a>
        </nav>
    </div>
...
<script>
    ...
    L.imageOverlay('../images/RDC.jpg', bounds).addTo(map);
